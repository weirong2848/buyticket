...
layui.define(function (e) {
    ...
    u.prototype.type = function () {
        ...
        var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1, i = {
            ...
            }(), count: '<span class="layui-laypage-count">鍏� ' + a.count + " 鏉�</span>", limit: function () {
...
!function () {
    ...
    var e = window.layui && layui.define, t = {
        ...
        l = "寮€濮嬫棩鏈熻秴鍑轰簡缁撴潫鏃ユ湡<br>寤鸿閲嶆柊閫夋嫨", d = [100, 2e5], c = "layui-laydate-static", m = "layui-laydate-list",
        u = "laydate-selected", h = "layui-laydate-hint", y = "laydate-day-prev", f = "laydate-day-next",
        p = "layui-laydate-footer", g = ".laydate-btns-confirm", v = "laydate-time-text", D = ".laydate-btns-time",
        T = function (e) {
            var t = this;
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        var e = this, t = e.config, n = {
            cn: {
                ...
                tools: {confirm: "纭畾", clear: "娓呯┖", now: "鐜板湪"}
            },
            en: {
        ...
        var n = this, a = n.config, i = a.dateTime, r = n.lang(),
            ...
            f = "cn" === a.lang, p = f ? "骞�" : "", T = n.listYM[t] || {}, C = ["hours", "minutes", "seconds"],
    ...
    p.prototype.config = {
        ...
        var n, o = this, l = o.config, r = o.elemFile[0], u = function () {
            ...
            if (o.elemFile.next("." + s).remove(), r.value = "", "object" != typeof t) try {
                ...
                return t = {}, o.msg("璇峰涓婁紶鎺ュ彛杩斿洖鏈夋晥JSON")
            }
        ...
        var e = this, i = e.config, o = function (t) {
            ...
            var a = e.elemFile,
                o = t.length > 1 ? t.length + "涓枃浠�" : (t[0] || {}).name || a[0].value.match(/[^\/\\]+\..+/g) || [] || "";
...
layui.define("layer", function (e) {
    ...
    var i = layui.$, t = layui.layer, a = layui.hint(), n = layui.device(), l = "form", r = ".layui-form",
        s = "layui-this", u = "layui-hide", o = "layui-disabled", c = function () {
            this.config = {
                verify: {
    ...
    c.prototype.set = function (e) {
        ...
        var n = this, c = i(r + function () {
            ...
            select: function () {
                var e, t = "璇烽€夋嫨", a = "layui-form-select", n = "layui-select-title", r = "layui-select-none", d = "",
                        ...
                        if (!c) {
                            ...
                            var C = function (e, t, a) {
                                ...
                                return 9 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && (C(i, function (e) {
                                    e ? k.find("." + r)[0] || k.append('<p class="' + r + '">鏃犲尮閰嶉」</p>') : k.find("." + r).remove()
                ...
                f.each(function (e, l) {
                    var r = i(this), u = r.next("." + a), c = this.disabled, d = l.value,
                ...
                t.each(function (t, n) {
                    ...
                    var d = l.next("." + c[0]),
                        f = i(['<div class="layui-unselect ' + c[0] + (n.checked ? " " + c[1] : "") + (u ? " layui-checkbox-disbaled " + o : "") + '" lay-skin="' + (r || "") + '">', {_switch: "<em>" + ((n.checked ? s[0] : s[1]) || "") + "</em><i></i>"}[r] || (n.title.replace(/\s/g, "") ? "<span>" + n.title + "</span>" : "") + '<i class="layui-icon">' + (r ? "&#xe605;" : "&#xe618;") + "</i>", "</div>"].join(""));
                ...
                var e = "layui-form-radio", t = ["&#xe643;", "&#xe63f;"], a = c.find("input[type=radio]"),
                    n = function (a) {
                        ...
                        a.on("click", function () {
                            var u = n[0].name, o = n.parents(r), c = n.attr("lay-filter"),
                ...
                a.each(function (a, l) {
                    ...
                    if ("string" == typeof r.attr("lay-ignore")) return r.show();
                    var c = i(['<div class="layui-unselect ' + e + (l.checked ? " " + e + "ed" : "") + (u ? " layui-radio-disbaled " + o : "") + '">', '<i class="layui-anim layui-icon">' + t[l.checked ? 0 : 1] + "</i>", "<span>" + (l.title || "鏈懡鍚�") + "</span>", "</div>"].join(""));
    ...
    var d = function () {
        var e = i(this), a = f.config.verify, s = null, u = "layui-form-danger", o = {}, c = e.parents(r),
...
layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    A.prototype.config = {limit: 10, loading: !0, cellMinWidth: 60}, A.prototype.render = function () {
        ...
        if (a.elem = t(a.elem), a.where = a.where || {}, a.id = a.id || a.elem.attr("id"), a.request = t.extend({
            ...
            dataName: "data",
            countName: "count"
        }, a.response), "object" == typeof a.page && (a.limit = a.page.limit || a.limit, a.limits = a.page.limits || a.limits, e.page = a.page.curr || e.page, delete a.page.elem, delete a.page.jump), !a.elem[0]) return e;
        e.setArea();
        var l = a.elem, n = l.next("." + y), o = e.elem = t(i(S).render({VIEW_CLASS: y, data: a, index: e.index}));
        ...
        }), o > n && a && (l = (o - n) / a), layui.each(t.cols, function (e, i) {
        ...
        if (n.url) {
            ...
            c[o.pageName] = e, c[o.limitName] = n.limit, t.ajax({
                ...
                dataType: "json",
                success: function (t) {
                    return t[r.statusName] != r.statusCode ? (a.renderForm(), a.layMain.html('<div class="' + f + '">' + (t[r.msgName] || "杩斿洖鐨勬暟鎹姸鎬佸紓甯�") + "</div>")) : (a.renderData(t, e, t[r.countName]), d(), i && l.close(i), void ("function" == typeof n.done && n.done(t, e, t[r.countName])))
                },
                error: function (e, t) {
                    ...
                    if (void 0 !== h && null !== h || (h = ""), !(n.colspan > 1)) {
                        var y = ['<td data-field="' + r + '" ' + function () {
                            ...
                            return "checkbox" === n.type ? '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" ' + function () {
                                ...
                                return n[t] ? (e[t] = n[t], n[t] ? "checked" : "") : e[t] ? "checked" : ""
        ...
        return c.key = s.id || s.index, d.cache[c.key] = u, r ? m() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + f).remove(), c.layMain.append('<div class="' + f + '">鏃犳暟鎹�</div>')) : (m(), void (s.page && (c.page = n, c.count = o, s.page = t.extend({
        ...
        var r, c, u = this, h = {}, f = u.config, y = f.elem.attr("lay-filter"), p = d.cache[u.key];
        ...
        u.sortKey = {
            field: r,
            sort: i
        }, "asc" === i ? c = layui.sort(p, r) : "desc" === i ? c = layui.sort(p, r, !0) : (c = layui.sort(p, d.config.indexName), delete u.sortKey), h[f.response.dataName] = c, u.renderData(h, u.page, u.count, !0), l.close(u.tipsIndex), n && layui.event.call(e, s, "sort(" + y + ")", {
            field: r,
            type: i
        })
        ...
        if (t.loading && t.url) return l.msg("鏁版嵁璇锋眰涓�", {
            icon: 16,
            offset: [e.elem.offset().top + e.elem.height() / 2 - 35 - H.scrollTop() + "px", e.elem.offset().left + e.elem.width() / 2 - 90 - H.scrollLeft() + "px"],
            anim: -1,
            fixed: !1
        })
        ...
        t.fullHeightGap && (a = H.height() - t.fullHeightGap, a < 135 && (a = 135), t.elem.css("height", a)), e = parseFloat(a) - parseFloat(t.layHeader.height()) - 1, i.toolbar && (e -= t.layTool.outerHeight()), i.page && (e = e - t.layPage.outerHeight() - 1), t.layMain.css("height", e)
        ...
        if (n && !e.scrollPatchWStatus) {
            var o = e.layHeader.eq(0).find("thead th:last-child"), r = o.data("field");
            e.getCssRule(r, function (t) {
                var i = t.style.width || o.outerWidth();
                t.style.width = parseFloat(i) - n + "px", e.scrollPatchWStatus = !0
            })
        }
        if (a && l) {
            if (!e.elem.find(".layui-table-patch")[0]) {
                var d = t('<th class="layui-table-patch"><div class="layui-table-cell"></div></th>');
                d.find("div").css({width: a}), e.layHeader.eq(0).find("thead tr").append(d)
            }
        } else e.layHeader.eq(0).find(".layui-table-patch").remove();
        var c = e.layMain.height(), s = c - l;
        e.layFixed.find(m).css("height", i.height() > s ? s : "auto"), e.layFixRight[i.width() > e.layMain.width() ? "removeClass" : "addClass"](h), e.layFixRight.css("right", a - 1)
...
layui.define("jquery", function (t) {
    ...
    var e = layui.$, i = {
        fixbar: function (t) {
            var i, o, a = "layui-fixbar", l = "layui-fixbar-top", n = e(document), r = e("body");
            t = e.extend({showHeight: 200}, t), t.bar1 = t.bar1 === !0 ? "&#xe606;" : t.bar1, t.bar2 = t.bar2 === !0 ? "&#xe607;" : t.bar2, t.bgcolor = t.bgcolor ? "background-color:" + t.bgcolor : "";
            var c = [t.bar1, t.bar2, "&#xe604;"],
                u = e(['<ul class="' + a + '">', t.bar1 ? '<li class="layui-icon" lay-type="bar1" style="' + t.bgcolor + '">' + c[0] + "</li>" : "", t.bar2 ? '<li class="layui-icon" lay-type="bar2" style="' + t.bgcolor + '">' + c[1] + "</li>" : "", '<li class="layui-icon ' + l + '" lay-type="top" style="' + t.bgcolor + '">' + c[2] + "</li>", "</ul>"].join("")),
                s = u.find("." + l), g = function () {
                    var e = n.scrollTop();
                    e >= t.showHeight ? i || (s.show(), i = 1) : i && (s.hide(), i = 0)
                };
            e("." + a)[0] || ("object" == typeof t.css && u.css(t.css), r.append(u), g(), u.find("li").on("click", function () {
                var i = e(this), o = i.attr("lay-type");
                "top" === o && e("html,body").animate({scrollTop: 0}, 200), t.click && t.click.call(this, o)
            ...
            var o = this, a = "function" == typeof e, l = new Date(t).getTime(),
                n = new Date(!e || a ? (new Date).getTime() : e).getTime(), r = l - n,
                c = [Math.floor(r / 864e5), Math.floor(r / 36e5) % 24, Math.floor(r / 6e4) % 60, Math.floor(r / 1e3) % 60];
            a && (i = e);
            var u = setTimeout(function () {
                o.countdown(t, n + 1e3, i)
            }, 1e3);
            return i && i(r > 0 ? c : [0, 0, 0, 0], e, u), r <= 0 && clearTimeout(u), u
        }, timeAgo: function (t, e) {
            var i = this, o = [[], []], a = (new Date).getTime() - new Date(t).getTime();
            return a > 6912e5 ? (a = new Date(t), o[0][0] = i.digit(a.getFullYear(), 4), o[0][1] = i.digit(a.getMonth() + 1), o[0][2] = i.digit(a.getDate()), e || (o[1][0] = i.digit(a.getHours()), o[1][1] = i.digit(a.getMinutes()), o[1][2] = i.digit(a.getSeconds())), o[0].join("-") + " " + o[1].join(":")) : a >= 864e5 ? (a / 1e3 / 60 / 60 / 24 | 0) + "澶╁墠" : a >= 36e5 ? (a / 1e3 / 60 / 60 | 0) + "灏忔椂鍓�" : a >= 12e4 ? (a / 1e3 / 60 | 0) + "鍒嗛挓鍓�" : a < 0 ? "鏈潵" : "鍒氬垰"
        }, digit: function (t, e, i) {
            var o = "";
            t = String(t), e = e || 2;
            for (var a = t.length; a < e; a++) o += "0";
            return t < Math.pow(10, e) ? o + (0 | t) : t
        }
    };
    t("util", i)
});
    ...
    o.prototype.load = function (e) {
        ...
        if (f[0]) {
            var m = l(e.scrollElem || document), u = e.mb || 50, s = !("isAuto" in e) || e.isAuto,
                v = e.end || "娌℃湁鏇村浜�", y = e.scrollElem && e.scrollElem !== document, d = "<cite>鍔犺浇鏇村</cite>",
